...
<html lang="en">
<head>
    <title>Code coverage report for lib/assertions.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/assertions.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.02% <small>(456 / 470)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">94.26% <small>(230 / 244)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.95% <small>(127 / 131)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">97.02% <small>(456 / 470)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; assertions.js</div>
</div>
<div class="body">
...
860
861
862</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2329</span>
<span class="cline-any cline-yes">2329</span>
<span class="cline-any cline-yes">2329</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var ansiRegex = require('ansi-regex')();
...
&nbsp;
            ...
            this.errorMode = 'nested';
            expect.fail('threw: {0}', isUnexpected ? <span class="branch-0 cbranch-no" title="branch not covered" >error.output </span>: expect.inspect(error));
        } else {
        ...
        return expect.promise.all(promiseByKey).caught(function () {
            return expect.promise.settle(promiseByKey).then(function () {
                expect.fail(function (output) {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (subjectOutput.size().height &gt; 1) {
<span class="cstat-no" title="statement not covered" >                        output.nl();</span>
                    } else {
                        output.sp();
                    }
                    subjectOutput.error(':');
...
&nbsp;
                    ...
                    Object.keys(promiseByKey).forEach(function (key) {
                        ...
                        if (promise.isRejected()) {
                            ...
                            <span class="missing-if-branch" title="else path not taken" >E</span>if (error._isUnexpected) {
                                output.block(error.output);
                            } else {
<span class="cstat-no" title="statement not covered" >                                output.block(output.clone().text(error.message));</span>
                            }
                        }
                    });
                });
...
&nbsp;
    expect.addAssertion('Error', 'to [exhaustively] satisfy [assertion]', function (expect, subject, value) {
        ...
        if (valueType.is('Error')) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.flags.exhaustively) {
<span class="cstat-no" title="statement not covered" >                expect(utils.getKeysOfDefinedProperties(subject), 'to have length', keys.filter(<span class="fstat-no" title="function not covered" >function (key) {</span></span>
<span class="cstat-no" title="statement not covered" >                    return typeof value[key] !== 'undefined';</span>
                }).length);
            }
        } else {
...
&nbsp;
    expect.addAssertion('binaryArray', 'to [exhaustively] satisfy', function (expect, subject, value) {
        if (typeof value === 'function') {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (value._expectIt) {
                expect.withError(function () {
                    value(subject);
                }, <span class="fstat-no" title="function not covered" >function (e) {</span>
<span class="cstat-no" title="statement not covered" >                    expect.fail({</span>
                        diff: <span class="fstat-no" title="function not covered" >function (output, diff, inspect, equal) {</span>
...
<span class="cstat-no" title="statement not covered" >                value(subject);</span>
            }
        } else {
...
<span class="cstat-no" title="statement not covered" >                        reject(e);</span>
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!e || !e._isUnexpected) {
<span class="cstat-no" title="statement not covered" >                        reject(e);</span>
                    } else {
                        resolve();
                    }
            ...
            if (typeof value === 'string') {
                ...
                return expect.apply(expect, [subject, this.flags.exhaustively ? <span class="branch-0 cbranch-no" title="branch not covered" >'to exhaustively satisfy' </span>: 'to satisfy'].concat(Array.prototype.slice.call(arguments, 2)));
            }
...
&nbsp;
                                        if (!(key in value)) {
                                            ...
                                            if (typeof value[key] === 'function') {
                                                ...
                                                annotation.error(conflicting.label || <span class="branch-1 cbranch-no" title="branch not covered" >'should satisfy')</span>.sp()
...
&nbsp;
    function wrapDiffWithTypePrefixAndSuffix(e, type) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (createDiff) {
