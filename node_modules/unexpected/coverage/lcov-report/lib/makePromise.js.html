...
<html lang="en">
<head>
    <title>Code coverage report for lib/makePromise.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/makePromise.js</span></h1>
    <h2>
        
        Statements: <span class="metric">91.89% <small>(68 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">87.1% <small>(27 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; makePromise.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1723</span>
<span class="cline-any cline-yes">1723</span>
<span class="cline-any cline-yes">1723</span>
<span class="cline-any cline-yes">1723</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1814</span>
<span class="cline-any cline-yes">1724</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2251</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
        ...
        var runner = function (cb) {
            ...
            return function () {
                ...
                try {
                    ...
                    if (isPromise(result)) {
                        runningTasks += 1;
                        result.then(<span class="fstat-no" title="function not covered" >function (value) {</span>
...
<span class="cstat-no" title="statement not covered" >                            runningTasks -= 1;</span>
<span class="cstat-no" title="statement not covered" >                            finishWhenDone();</span>
                        }).caught(function (e) {
                            errors.push(e);
                            runningTasks -= 1;
                            finishWhenDone();
                        });
                    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof result !== 'undefined') {
<span class="cstat-no" title="statement not covered" >                        values.push(result);</span>
                    }
                } catch (e) {
                    errors.push(e);
                } finally {
...
function extractPromisesFromObject(obj) {
    if (isPromise(obj)) {
        return [obj];
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (obj &amp;&amp; typeof obj === 'object') {
        var promises = [];
        // Object or Array
