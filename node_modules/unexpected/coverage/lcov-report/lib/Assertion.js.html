...
<html lang="en">
<head>
    <title>Code coverage report for lib/Assertion.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/Assertion.js</span></h1>
    <h2>
        
        Statements: <span class="metric">80.77% <small>(21 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">80.77% <small>(21 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; Assertion.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var createStandardErrorMessage = require('./createStandardErrorMessage');
&nbsp;
...
Assertion.prototype.shift = function (subject, assertionIndex) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof rest[0] === 'function') {
<span class="cstat-no" title="statement not covered" >        return rest[0](subject);</span>
    } else {
        return this.expect.apply(this.expect, [subject].concat(rest));
    }
};
&nbsp;
Assertion.prototype.throwStandardError = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    var err = new Error();</span>
<span class="cstat-no" title="statement not covered" >    err.output = this.standardErrorMessage();</span>
<span class="cstat-no" title="statement not covered" >    err._isUnexpected = true;</span>
